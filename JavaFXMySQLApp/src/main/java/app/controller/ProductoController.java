...
public class ProductoController {
    ...
    private void handleHelpButton() {
        ...
        alert.setTitle("Ayuda - Menu De Creación de un Producto");
        alert.setHeaderText("Funcionalidades del Módulo");

        // Configuramos el contenido del mensaje
        alert.setContentText("Este módulo permite la Creacion de un Producto en la Base de Datos :\n"
                + "\n"
                + "1. Ingrese Los Datos Correctos para Continuar.\n"
                + "----------------------------------------------------------------------\n"
                + "2. Para Seleccionar la Categoría haga Click en el *ChoiceBox* y Seleccione una de las opciones.\n"
                + "----------------------------------------------------------------------\n"
